...
import net.mcreator.permadeathv.entity.renderer.ZombieRabanoRenderer;
import net.mcreator.permadeathv.PermadeathvModElements;

@PermadeathvModElements.ModElement.Tag
public class ZombieRabanoEntity extends PermadeathvModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.95f)).build("zombie_rabano").setRegistryName("zombie_rabano");
	public ZombieRabanoEntity(PermadeathvModElements instance) {
		super(instance, 88);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZombieRabanoRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("zombie_rabano_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.BEETROOT, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Items.BEETROOT, (int) (1)));
