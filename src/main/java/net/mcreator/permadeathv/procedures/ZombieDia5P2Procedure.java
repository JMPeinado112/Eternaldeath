...
public class ZombieDia5P2Procedure extends PermadeathvModElements.ModElement {
	public ZombieDia5P2Procedure(PermadeathvModElements instance) {
		super(instance, 17);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PermadeathvMod.LOGGER.warn("Failed to load dependency entity for procedure ZombieDia5P2!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				PermadeathvMod.LOGGER.warn("Failed to load dependency sourceentity for procedure ZombieDia5P2!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PermadeathvMod.LOGGER.warn("Failed to load dependency world for procedure ZombieDia5P2!");
			return;
		}
